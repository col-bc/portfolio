    ...
    <section className="flex flex-col items-start gap-8 px-4 py-8 md:mb-12 md:gap-12">
      ...
      <div className="flex flex-col gap-4 text-sm leading-relaxed">
        <p className="text-base leading-relaxed text-foreground">
          ...
          efficient applications. With over 5 years of experience in the
          industry, I have a strong background in full-stack development, cloud
        ...
        <p className="text-base leading-relaxed text-foreground">
          ...
          am always eager to take on new challenges and contribute to innovative
      ...
      <div className="flex flex-col gap-6 md:gap-8">
        ...
        <Card className="shadow">
          ...
          <CardContent className="flex flex-col">
            ...
            <h5 className="mt-4 font-semibold">Relevant Coursework</h5>
            ...
            <h6 className="mt-4 font-semibold">Additional Coursework</h6>
            <ul className="list-disc pl-4">
              <div className="my-2 grid grid-cols-1 gap-1 md:grid-cols-2">
                <li>Calculus I & II</li>
                <li>Physics I & II</li>
            ...
            <div className="flex flex-1 flex-col">
              ...
              <CardDescription>
                <Link
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="block text-base text-foreground hover:underline"
                >
