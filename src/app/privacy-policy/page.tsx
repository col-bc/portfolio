...
export default function PrivacyPolicy() {
  return (
    <section className="flex flex-col gap-6 px-4 py-12 md:gap-8">
      <div className="space-y-4 border-b-4 border-b-muted pb-4">
      ...
      <div className="space-y-4">
        ...
        <p className="leading-relaxed text-pretty text-foreground">
          When you access our website, certain data is automatically collected
          to ensure the site runs securely and efficiently:
        </p>
        <ul className="list-disc space-y-2 pl-6 leading-relaxed text-pretty text-foreground">
          <li className="leading-relaxed text-pretty text-foreground">
            <strong className="font-bold">Analytics Data:</strong> We use Google
            Analytics to understand how visitors interact with the site. This
            may include your device type, browser type, geographic location (at
            a high level), pages visited, and time spent on the site.
          </li>
          <li className="leading-relaxed text-pretty text-foreground">
            ...
            performance. Cloudflare may log IP addresses, browser information,
            and network routing data to prevent malicious activity.
          </li>
          <li className="leading-relaxed text-pretty text-foreground">
            <strong className="font-bold">Admin Gateway Data:</strong> Our
            system features a private administrative login not intended for
            public use. If accessed, the system logs the user&rsquo;s IP address
            and browser information strictly for security and access-control
            purposes.
          </li>
        </ul>
      </div>
      ...
      <div className="space-y-4">
        ...
        <ul className="list-disc space-y-2 pl-6 leading-relaxed text-pretty text-foreground">
          ...
          <li className="leading-relaxed text-pretty text-foreground">
            <strong className="font-bold">To Improve Our Website:</strong>{' '}
            Google Analytics data helps us understand visitor trends and improve
            the content and user experience of our portfolio.
          </li>
          <li className="leading-relaxed text-pretty text-foreground">
      ...
      <div className="space-y-4">
        ...
        <p className="leading-relaxed text-pretty text-foreground">
          ...
          do share data with trusted third-party service providers who help us
          operate the website:
        </p>
        <ul className="list-disc space-y-2 pl-6 leading-relaxed text-pretty text-foreground">
          <li className="leading-relaxed text-pretty text-foreground">
            <strong className="font-bold">Hosting and Infrastructure:</strong>{' '}
            Our website is hosted on Google Cloud Platform (GCP) and proxied
            through Cloudflare. These providers handle the data securely as part
            of our core infrastructure.
          </li>
          <li className="leading-relaxed text-pretty text-foreground">
          ...
          <li className="leading-relaxed text-pretty text-foreground">
            ...
            contents of your contact form messages may be securely transmitted
            to third-party LLM APIs (such as OpenAI, Anthropic, or Google)
            strictly for the purpose of processing and responding to your
            inquiry.
          </li>
        </ul>
      </div>
      ...
      <div className="space-y-4">
        ...
        <p className="leading-relaxed text-pretty text-foreground">
          ...
          security measures to protect your personal information. While our
          infrastructure relies on industry-standard providers (GCP and
          Cloudflare) to ensure a secure environment, please be aware that no
