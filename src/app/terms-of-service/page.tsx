    ...
    <section className="flex flex-col gap-6 px-4 py-12 md:gap-8">
      ...
      <div className="space-y-4">
        ...
        <p className="leading-relaxed text-pretty text-foreground">
          ...
          must immediately discontinue use of this website.
        </p>
      </div>
      ...
      <div className="space-y-4">
        ...
        <p className="leading-relaxed text-pretty text-foreground">
          ...
          form and any communication features responsibly and truthfully. You
          are responsible for maintaining and mitigating any risks associated
      ...
      <div className="space-y-4">
        ...
        <p className="leading-relaxed text-pretty text-foreground">
          ...
          personal information stored therein; or (iii) any other matter
      ...
      <div className="space-y-4">
        ...
        <p className="leading-relaxed text-pretty text-foreground">
          ...
          graphics, logos, images, and software, is the property of the website
      ...
      <div className="space-y-3">
        ...
        <p className="leading-relaxed text-pretty text-foreground">
          All code, projects, and technical information provided on this site
          are for demonstration purposes and are provided on an
          &quot;as-is&quot; and &quot;as available&quot; basis, without any
          warranties of any kind. We do not warrant that the website or its
          contents will be error-free, secure, or uninterrupted.
        </p>
      </div>
      ...
      <div className="space-y-4">
        ...
        <p className="leading-relaxed text-pretty text-foreground">
          ...
          regarding your use of the website and supersede any prior agreements
          or understandings, whether written or oral, relating to the subject
          matter herein.
        </p>
      </div>
